...
import com.maximcuker.notesmvi.business.interactors.common.DeleteNote.Companion.DELETE_ARE_YOU_SURE
import com.maximcuker.notesmvi.business.interactors.common.DeleteNote.Companion.DELETE_NOTE_SUCCESS
import com.maximcuker.notesmvi.business.interactors.notedetail.UpdateNote.Companion.UPDATE_NOTE_FAILED_PK
import com.maximcuker.notesmvi.business.interactors.notedetail.UpdateNote.Companion.UPDATE_NOTE_SUCCESS
import com.maximcuker.notesmvi.framework.presentation.common.*
import com.maximcuker.notesmvi.framework.presentation.notedetail.state.CollapsingToolbarState
...
import com.maximcuker.notesmvi.framework.presentation.notedetail.state.NoteInteractionState
import com.maximcuker.notesmvi.framework.presentation.notelist.NOTE_PENDING_DELETE_BUNDLE_KEY
...
constructor(
    ...
    private fun transitionToCollapsedMode() {
        note_title.fadeOut()
        this.displayToolbarTitle(tool_bar_title, getNoteTitle(), true)
    }
