package com.maximcuker.notesmvi.framework.datasource.cache
...
/*
    ...
    4. insert 1000 new notes, confirm db size increased
    5. insert 1000 new notes, confirm filtered search query works correctly
...
class NoteDaoServiceTests : BaseTest() {
    ...
    //    4. insert 1000 new notes, confirm db size increased
    @Test
    fun insert1000Notes_confirmNumNotesInDb1() = runBlocking {
